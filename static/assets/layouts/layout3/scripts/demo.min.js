var Demo = function () {
    var e = function () {
        ...
        var t = function () {
            ...
            var a = $(".theme-setting-layout", e).val(), n = $(".theme-setting-top-menu-style", e).val(), o = $(".theme-setting-top-menu-mode", e).val(), i = $(".theme-setting-mega-menu-style", e).val(), s = $(".theme-setting-mega-menu-mode", e).val();
        ...
        $(".theme-colors > li", e).click(function () {
            ...
            var t = $(".theme-setting-top-menu-mode", e).val(), a = $(".theme-setting-mega-menu-mode", e).val();
